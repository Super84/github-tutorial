...
//@Disabled
public class Vuforia_Teleop extends OpMode {
    // Declare OpMode members.

    Vuforia_Robot robot = new Vuforia_Robot();
    ...
    public void loop() {
        ...
        telemetry.addData("Pos (in)", "{X, Y, Z} = %.1f, %.1f, %.1f", robot.vuforia.getX(), robot.vuforia.getY(), robot.vuforia.getZ());
        telemetry.addData("Rot (deg)", "{Roll, Pitch, Heading} = %.0f, %.0f, %.0f", robot.vuforia.getRoll(), robot.vuforia.getPitch(), robot.vuforia.getHeading());
    }
