...
public class IMU_Robot {
    ...
    public void init(HardwareMap ahwMap) {
        ...
        //Set up the IMU with parameters
        BNO055IMU.Parameters parameters = new BNO055IMU.Parameters();

        //Mode needs to be set to IMU, and angle to degrees instead of radians. AccelUnit
        //may not be needed for gyroscope only
    ...
    //Drive instantiation, see Blue_2021_Robot for more details.
    ...
    //Pivot instantiation, see Blue_2021_Robot for more details.
    ...
    //Intake instantiation, see Blue_2021_Robot for more details.
    ...
    //Duck Spinner instantiation, see Blue_2021_Robot for more details.
