...
public class Vuforia {
     ...
     * @param robot The Vuforia_Robot class that has the hardwareMap stored within
     ...
     */
    public Vuforia(Vuforia_Robot robot, float cameraHeight, float cameraLeft, float cameraOut) {
        this.robot = robot;
